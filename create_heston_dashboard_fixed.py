...
PLOTS_DIR = "heston_simulation/plots"
OUTPUT_DIR = "heston_simulation"
...
def check_plots():
    ...
    if missing_plots:
        ...
        os.system('python fix_heston.py')
...
def create_dashboard():
    ...
    img1 = mpimg.imread(os.path.join(PLOTS_DIR, 'heston_single_path.png'))
    ax1.imshow(img1)
    ...
    img2 = mpimg.imread(os.path.join(PLOTS_DIR, 'heston_multiple_paths.png'))
    ax2.imshow(img2)
    ...
    img3 = mpimg.imread(os.path.join(PLOTS_DIR, 'heston_distribution.png'))
    ax3.imshow(img3)
    ...
    img4 = mpimg.imread(os.path.join(PLOTS_DIR, 'heston_parameter_comparison.png'))
    ax4.imshow(img4)
    ...
    img5 = mpimg.imread(os.path.join(PLOTS_DIR, 'heston_volatility_clustering.png'))
    ax5.imshow(img5)
    ...
    img6 = mpimg.imread(os.path.join(PLOTS_DIR, 'heston_option_pricing.png'))
    ax6.imshow(img6)
    ...
    # Save the dashboard
    dashboard_path = os.path.join(OUTPUT_DIR, 'heston_dashboard.png')
