...
plt.savefig('gbm_single_path.png')
print("Saved single path plot to 'gbm_single_path.png'")
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('gbm_multiple_paths.png')
print(f"Saved multiple paths plot to 'gbm_multiple_paths.png'")
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('gbm_distribution.png')
print(f"Saved distribution plot to 'gbm_distribution.png'")
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('gbm_methods_comparison.png')
print(f"Saved methods comparison plot to 'gbm_methods_comparison.png'")
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('gbm_convergence.png')
print(f"Saved convergence analysis plot to 'gbm_convergence.png'")
