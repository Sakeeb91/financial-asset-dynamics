...
class HestonModel:
    ...
    def __init__(self, mu, kappa, theta, xi, rho, s0, v0):
        ...
        """
        self.mu = mu  # Drift
        self.sigma = np.sqrt(theta)  # Reference volatility (not directly used)
        self.x0 = s0  # Initial price
...
if __name__ == "__main__":
    ...
    output_dir = "heston_simulation/plots"
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'heston_single_path.png'))
    print(f"Saved single path plot to '{output_dir}/heston_single_path.png'")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'heston_multiple_paths.png'))
    print(f"Saved multiple paths plot to '{output_dir}/heston_multiple_paths.png'")
    ...
    plt.savefig(os.path.join(output_dir, 'heston_distribution.png'))
    print(f"Saved distribution plot to '{output_dir}/heston_distribution.png'")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'heston_parameter_comparison.png'))
    print(f"Saved parameter comparison plot to '{output_dir}/heston_parameter_comparison.png'")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'heston_volatility_clustering.png'))
    print(f"Saved volatility clustering plot to '{output_dir}/heston_volatility_clustering.png'")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'heston_option_pricing.png'))
    print(f"Saved option pricing and volatility smile plot to '{output_dir}/heston_option_pricing.png'")
    ...
    print("\nSimulation complete! All plots saved to the heston_simulation/plots directory.") 